		...
		<div class="collapse text-center navbar-collapse" id="navbarsid">
			...
			<div class="my-md-0 ml-lg-4 mt-4 mt-lg-0 ml-auto text-lg-right mb-3 mb-lg-0">
				<a href="tel:+23-345-67890">
					<h3 class="text-color mb-0"><i class="ti-mobile mr-2"></i>+FSC GYM</h3>
				</a>
			</div>
		</div>
	</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-8">
				...
				<h1 class="text-uppercase text-white mb-5">Step up your <span class="text-color">fitness Challenge</span><br>with us</h1>
			
				<a href="pricing.html" target="_blank" class="btn btn-main " >Book session now <i class="ti-angle-right ml-3"></i></a>
			</div>
		</div>
	</div>
</section>
